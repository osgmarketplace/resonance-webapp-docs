...
#### `hasNextPage` ([`Boolean`](/developers/shared-apis/adminidentity-api/graphql/reference/scalars/boolean))
...
#### `hasPreviousPage` ([`Boolean`](/developers/shared-apis/adminidentity-api/graphql/reference/scalars/boolean))
