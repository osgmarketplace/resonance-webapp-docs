...
#### `endCursor` ([`String`](/developers/demandhq-apis/demand-api/graphql/reference/scalars/string))

The cursor to use when paginating forwards (using first/after). Will always be
populated regardless of if a next page exists.


#### `hasNextPage` ([`Boolean`](/developers/demandhq-apis/demand-api/graphql/reference/scalars/boolean))
...
#### `hasPreviousPage` ([`Boolean`](/developers/demandhq-apis/demand-api/graphql/reference/scalars/boolean))
...
#### `startCursor` ([`String`](/developers/demandhq-apis/demand-api/graphql/reference/scalars/string))
